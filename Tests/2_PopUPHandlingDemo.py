...
if browser == 'chrome':
    driver = webdriver.Chrome(executable_path="F:/Selenium/New_folder/Drivers/chromedriver.exe")
    # driver = webdriver.Chrome()
    # driver.get("https://www.makemytrip.com/")
elif browser == 'firefox':
    driver = webdriver.Firefox(executable_path="F:/Selenium/New_folder/Drivers/geckodriver.exe")
    # driver = webdriver.Firefox()
    # driver.get("https://www.makemytrip.com/")
elif browser == 'ie':
    driver = webdriver.Ie(executable_path="F:/Selenium/New_folder/Drivers/IEDriverServer.exe")
    # driver = webdriver.Ie()
else:
    print("Error - Provide appropriate browser name")

location = "file:///F:/Selenium/New_folder/DemoFile/popup.html"
driver.get(location)
